...
- **Next operational seam**: Stage 4K must select one new behavior-owned seam, preserve or add focused regression coverage, and reduce only its directly owned static debt; do not restart package-surface cleanup or broaden into a repository-wide typing pass.
