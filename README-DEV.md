...
- **Next operational seam**: Stage 4O must make the remaining lower color controls accessible at `900×450`, preserving the Stage 4N group headings, list/ticker, and Controls toggle. Start with a focused real-Tk layout contract; do not relax the checklist or broaden into a visual redesign.
