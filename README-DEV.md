...
- **Next operational seam**: Stage 4P must classify ticker-edge clipping as intended marquee behavior or a persistent layout defect using controlled real-Tk evidence. Do not modify the ticker until that result is known; preserve the completed `900×450` Controls-panel contract.
