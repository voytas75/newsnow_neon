...
- **Next operational seam**: Stage 4N must make both options-panel group headings visible and usable at the default `900×450` geometry, preserving the proven list/ticker and Controls toggle. Start with a focused real-Tk layout contract; do not relax the checklist or broaden into a visual redesign.
