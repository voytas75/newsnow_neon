...
Current measured baseline, after P1 service compatibility and Stage 4A–4G:

| Tool | Result | Scope |
|---|---:|---|
| Ruff | 1,092 diagnostics | repository-wide |
...
- Security remote verification is complete. Stage 3C, the P0 policy decision,
  P1 service compatibility, and Stage 4A–4G are complete locally; the next
